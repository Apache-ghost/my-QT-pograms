...
#include <memory>
#include "../../../calender/calendardialog.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_calendardialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_calendardialog_t qt_meta_stringdata_calendardialog = {
    {
QT_MOC_LITERAL(0, 14) // "calendardialog"
...
const QMetaObject calendardialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_calendardialog.offsetsAndSize,
    qt_meta_data_calendardialog,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_calendardialog_t
